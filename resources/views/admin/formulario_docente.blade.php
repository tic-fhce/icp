                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form action="{{route('AddDocente')}}" method="post" enctype="multipart/form-data">
                                            @csrf
						    ...
						    <option Value="Dr.">Doctor</option>
                                            ...
                                            <button type="submit" class="btn btn-lg btn-info btn-block">Crear Docente</button>
