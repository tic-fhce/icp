                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#nota" role="tab" aria-controls="profile" aria-selected="false">Calificaciones</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="pago" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        @if($i-$c==0)
                                            <a href="{{route('Fincurso',$curso->id_estudiante)}}" class="btn btn-outline-success">Finalizar Plan</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <!--Nota Academica-->
                            <div class="tab-pane fade" id="nota" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <table class="table">
                                            <thead>
