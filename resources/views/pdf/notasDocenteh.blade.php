...
<body>
			...
			<table border="0" width="100%">
				<tr>
					...
					<td width="60%"><p class="titulo">ACTA DE CALIFICACIONES</p>
						...
						<p class="subtitulos">Modulo: {{$value->modulo}}</p>
						@endforeach</td>
		...
		<table border="0" width="100%">
			<tr>
				@foreach ($reporte as $value)
				<td colspan="2">Docente: {{$value->tipodocente}} {{$value->nombres}} {{$value->apellidos}}</td>
				@endforeach
		...
		<table border="1" width="100%" cellspacing=0 cellpadding=2 bordercolor="666633">
			<tbody>
				...
				<tr>
					...
					<td>{{$value->nombres}}</td>
					<td align="center">{{$value->nota}}</td>
					<td align="center">
						<?php $resultado = convertir($value->nota);
							echo $resultado;
						?>
					</td>
					</tr>
		...
		<table border="0" width="100%" cellspacing=0 cellpadding=2 bordercolor="666633">
			<tbody>
				<tr style="font-size: 15px">
					<th><hr width=60%  align="center"></th>
					<th><hr width=60%  align="center"></th>
				</tr>
				<tr style="font-size: 15px">
					@foreach ( $reporte as $value)
					<th>{{$value->tipodocente}} {{$value->nombres}} {{$value->apellidos}}</th>
					@endforeach
